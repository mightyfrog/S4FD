...
class BaseKnockback : BaseModel() {
    ...
    override fun toString(): String {
        return "BaseKnockback(id=$id, hitbox1=$hitbox1, hitbox2=$hitbox2, hitbox3=$hitbox3, hitbox4=$hitbox4, hitbox5=$hitbox5, hitbox6=$hitbox6, notes=$notes)"
    }
}